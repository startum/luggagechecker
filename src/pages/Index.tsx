        ...
        <div className="layout-container">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 text-left">
              ...
              <div className="bg-white p-5 sm:p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-300 sm:col-span-2 md:col-span-1 sm:max-w-md md:max-w-full mx-auto sm:mx-auto md:mx-0 w-full">
                <img 
