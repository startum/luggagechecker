    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="layout-container relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <form onSubmit={handleSearch} className="relative flex-grow">
                ...
                <Input 
                  ...
                  className="pl-10 h-14 w-full text-base rounded-xl border-2 border-gray-200 focus:border-teal"
                  value={searchTerm}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-20 w-full">
          ...
          <div 
            className="bg-white p-8 rounded-xl border-2 border-teal quirky-shadow-yellow hover:quirky-shadow animate-fade-in cursor-pointer hover:-translate-y-1 transition-all duration-300" 
          ...
          >
            <div className="w-16 h-16 bg-purple/20 rounded-lg flex items-center justify-center mb-5">
