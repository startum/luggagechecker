          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:w-1/2 mb-12 lg:mb-0">
            ...
            animationDelay: '0.2s'
              ...
              <form onSubmit={handleSearch} className="relative flex-grow w-full">
                ...
                <Button type="submit" size="lg" className="h-14 text-base px-6 font-semibold mt-2 sm:mt-0 sm:absolute sm:right-0 sm:top-0 sm:rounded-l-none bg-yellow-500 hover:bg-yellow-400 text-zinc-950">
