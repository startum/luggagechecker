...
const TransferSection = () => {
  ...
  useEffect(() => {
    ...
    script.async = true;
    script.src = 'https://tpemd.com/content?trs=448606&shmarker=664168&locale=en&color_scheme=orange&h=Transfer%20bookings&powered_by=true&promo_id=1586&campaign_id=22';
